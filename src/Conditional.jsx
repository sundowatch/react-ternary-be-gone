...
import { warnOnce, markerKindOf, IF, ELSE_IF, ELSE, CASE } from './markers';
...
const processArray = (array, { filter, sort, reverse, limit }) => {
...
const renderIterableChildren = (items, children, keyExtractor) =>
